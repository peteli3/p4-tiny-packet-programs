...
def main():
    ...
    insns = [
        0b0110001001000001010000011001101, # THIS IS A WORKING STORE 18, 10
        ...
        # 0b0110000000000000010000011001101, # THIS IS A WORKING STORE 0, 2
        ...
        0b0000001001000001010000011001101, # THIS IS A WORKING PUSH 18
